...
class Roboclaw:
    ...
    def SetM1PositionPID(self, address, kp, ki, kd, kimax, deadzone, min, max):
        # return self._write4444444(address,self.Cmd.SETM1POSPID,long(kd*1024),long(kp*1024),long(ki*1024),kimax,
        # deadzone,min,max)
    ...
    def SetM2PositionPID(self, address, kp, ki, kd, kimax, deadzone, min, max):
        # return self._write4444444(address,self.Cmd.SETM2POSPID,long(kd*1024),long(kp*1024),long(ki*1024),kimax,
        # deadzone,min,max)
